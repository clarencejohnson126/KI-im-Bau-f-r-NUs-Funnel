      ...
      <div className="bg-white/95 backdrop-blur-lg border-t border-concrete-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] p-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex-1">
            <p className="text-xs font-bold text-green-600 bg-green-100 px-2 py-0.5 rounded inline-block mb-0.5">
              100% GRATIS
            </p>
            <p className="font-display text-lg text-concrete-900 leading-none">
